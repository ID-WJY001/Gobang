...
void Rule_Page() {
	...
	f.lfHeight = 30;
	settextstyle(&f);
	outtextxy(260, 235, "1.�ڰ�˫���������ӣ��ڷ�Ϊ���֡�");
	outtextxy(260, 275, "2.�ںᡢ����б�������������ӣ���");
	outtextxy(290, 315, "��������ӽ�Ϊ��������Ϊʤ��");
	outtextxy(260, 355, "3.��������������У����Υ������");
	outtextxy(290, 395, "�����ֹ��򡱻ᱻ�и���");
	f.lfHeight = 25;
	settextstyle(&f);
	outtextxy(280, 435, "��1���������֣�������һ��λ�����Ӻ�");
	outtextxy(330, 465, "�γ��������������ϵĻ�����������");
	outtextxy(330, 495, "ָ�������������������ĺ��ӣ�����");
	outtextxy(330, 525, "�˶��п�λ���Լ��������γ�������");
	outtextxy(280, 555, "��2�����Ľ��֣�������һ��λ�����Ӻ�");
	outtextxy(330, 585, "�γ��������������ϵĻ��ġ�������");
	outtextxy(330, 615, "ָ�����������ĸ������ĺ��ӣ�����"); 
	outtextxy(330, 645, "��λ���Լ��������γ�������"); 
	outtextxy(280, 675, "��3���������֣�������һ��λ�����Ӻ�");
	outtextxy(330, 705, "�γ���������������ĺ��ӡ�"); 
	outtextxy(280, 735, "��4���������֣�������һ��λ�����Ӻ�"); 
	outtextxy(330, 765, "ͬʱ�γ�һ�����ĺ�һ������������");
	outtextxy(330, 795, "���Ҳ����Ϊ���֡�");
	bool flag = 0;
	ExMessage msg;
	while (1) {
		if (peekmessage(&msg)) {
...
void Details_Page() {
	...
	outtextxy(260, 605, "������Ա��������");
	outtextxy(260, 655, "������Ŀ��������");
	outtextxy(260, 705, "�������֣�Flower Dance");
	outtextxy(260, 755, "����ʱ�䣺2024.11.20-2024.12.24");
	bool flag = 0;
	ExMessage msg;
	while (1) {
		if (peekmessage(&msg)) {
